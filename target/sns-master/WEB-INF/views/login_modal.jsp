...
<div class="ui small modal login-tip">
    ...
    <form class="ui large from">
        <div class="field">
            <div class="ui left icon input">
                <i class="user icon"></i>
                <input id="email" type="text" name="email" placeholder="电子邮件">
            </div>
        </div>
        ...
        <a href='<c:url value="./account/register.jsp"/>' class="ui fluid large  submit button">注册</a>
        <!-- 这里需要修改 -->
    </form>
</div>