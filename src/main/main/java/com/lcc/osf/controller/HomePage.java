...
public class HomePage {
    ...
    public ModelAndView getFollowers(HttpSession session) {
        ...
        mav.addObject("followers", userService.findAllbyIDs(followService.getFollowerIDs(user_id)));
    ...
    public ModelAndView getFollowings(HttpSession session) {
        ModelAndView mav = new ModelAndView();
        int user_id = ((User) session.getAttribute("user")).getId();
        mav.addObject("followings", userService.findAllbyIDs(followService.getFollowingIDs(user_id)));
