...
import com.lcc.osf.dao.NotificationDAO;
...
public class NotificationDAOImpl implements NotificationDAO{
    ...
    public int save(final Notification notification) {
        final String sql = "insert into "+TABLE
                +" (notify_type,notify_id, object_type, object_id, notified_user, notifier) values(?,?,?,?,?,?)";
    ...
    public List<Notification> getNotificationsOfType(int user_id, Object... notify_types) {
