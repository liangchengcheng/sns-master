                ...
                <div class="album metas">
                    <div class="meta author">
                        <a href="<c:url value="/user/${u.id }" />">
                            <img class="ui avatar image" src="<c:url value="${img_base_url}${u.user_avatar }"/>"></a>
                    ...
                    <div class="ui tiny images meta" id="imgbox">
                        <c:forEach items="${album.photos}" var="photo">
                            <a href="#">
                                <img src="<c:url value="${img_base_url}${photo.key }${album_thumbnail }" />" alt=""
                                     id="preview_photo_${photo.id }"></a>
                        </c:forEach>
                    </div>
                    <div class="meta tags">
