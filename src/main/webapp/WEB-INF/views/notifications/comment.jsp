                        ...
                        <c:if test="${notification.notify_type eq dic.notify_type_comment }">
                            <div class="item">
                                <img class="ui avatar image"
                                     src="<c:url value="${img_base_url }${notification.notifier_avatar }" />">
                                <div class="content">
                                    <a class="header"
                                       href="<c:url value="/user/${notification.notifier }" /> ">${notification.notifier_name }</a>
                                    <c:if test="${notification.object_type eq dic.object_type_post }">
                                        <div class="description">评论了你的文章:<a
                                                href="<c:url value="/post/${notification.object_id }" />">
                                            <b>${notification.object_title }</b>
                                        </a> ${notification.ts }
                                        </div>
                                    </c:if>
                        ...
                        <c:if test="${notification.notify_type eq dic.notify_type_comment_reply }">
                            <div class="item">
                                ...
                                <div class="content">
                                    <a class="header"
                                       href="<c:url value="/user/${notification.notifier }" /> ">${notification.notifier_name }</a>
                                    <div class="description">回复了你在:<a
                                            href="<c:url value="/post/${notification.object_id }" />"><b>${notification.object_title }</b></a> ${notification.ts }
                                    </div>
                                </div>
                            </div>
                        </c:if>
